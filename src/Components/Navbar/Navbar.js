    ...
    return(
        <div className="bg-white shadow">
            <div className="w-full flex flex-col md:flex-row container mx-auto">
                {/* Menu Mobile  */}
                <div className="flex flex-row  md:justify-start py-8 px-6 md:px-0 items-center w-full md:w-40 justify-end">
                ...
                <div className={`${show ? 'flex absolute bg-white w-full' : 'hidden md:flex'} flex-col md:flex-row items-center flex-grow`} style={show ? {top: '6%'} : {}}>
